    ...
    <v-parallax :src="threebot_data.bg" height="100%">
      <v-row align="center" justify="center">
        <v-col class="text-center" cols="12">
          ...
          <v-btn color="#7DB78D" class="mt-8 mx-2" dark large @click.stop="openChatflow()">Deploy my 3Bot</v-btn>
          <v-btn color="#4472B5" class="mt-8 mx-2" dark large @click.stop="viewWorkloads()">View my 3Bot</v-btn>
        </v-col>
      </v-row>
    </v-parallax>
  </div>
