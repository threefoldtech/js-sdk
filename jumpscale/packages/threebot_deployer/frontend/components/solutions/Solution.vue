    ...
    <v-parallax :src="threebot_data.bg" height="100%">
      <v-row align="center" justify="center">
        <v-col class="text-center" cols="12">
          <h1 style="font-size: 60;" class="mb-2">Deploy your 3Bot</h1>
          <h3 class="subheading">This 3Bot will be your virtual system administrator, to allow you to quickly deploy apps on top of the TFGrid.</h3>
