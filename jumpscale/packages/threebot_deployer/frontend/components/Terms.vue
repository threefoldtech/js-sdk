    ...
    <v-card-text>
      ...
      <div class="text--primary">
        ...
        <ul>
          ...
          <li>The deployer you find here makes your life more easy to play with the ZOS 2.2 (0.4) on TFGrid 2.2</li>
        </ul>
        <br />
        <h4
        ...
        <ul>
          <li>3Bot is your virtual system administrator and here you can see our brand new 2.2 version, deploy your own version on the deployer (v2.2).</li>
        ...
        <p>
          you cannot use this deployer or the 3Bot unless you agree with
          see
          <a
            target="_blank"
