...
from jumpscale.packages.vdc.bottle.utils import (
    list_threebot_solutions,
    threebot_identity_context,
)
from jumpscale.packages.vdc.models import (
    BACKUP_MODEL_FACTORY,
    USER_THREEBOT_FACTORY,
)
from jumpscale.packages.vdc.models.user_solutions import ThreebotState
...
class ThreebotDeploy(MarketPlaceAppsChatflow):
    ...
    def _deploy(self):
        ...
        environment_vars = {
            ...
            "MARKETPLACE_URL": f"https://{j.sals.nginx.main.websites.vdc_vdc_root_proxy_443.domain}/",
