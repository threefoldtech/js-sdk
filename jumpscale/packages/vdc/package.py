...
class vdc:
    def install(self, **kwargs):
        ...
        if all([v for v in log_config.values()]):
            j.core.config.set("VDC_LOGGING_SINK", log_config)
            j.logger.info(
    ...
    def start(self, **kwargs):
        ...
        location_actors_443 = j.sals.nginx.main.websites.default_443.locations.get(name="vdc_actors")
        location_actors_443.is_auth = False
        location_actors_443.is_admin = False
        location_actors_443.save()

        location_actors_80 = j.sals.nginx.main.websites.default_80.locations.get(name="vdc_actors")
    ...
    def uninstall(self):
        ...
        """
        j.sals.nginx.main.websites.default_443.locations.delete("vdc_root_proxy")
        j.sals.nginx.main.websites.default_80.locations.delete("vdc_root_proxy")
