...
const JSONRender = httpVueLoader('/vueui/base/JSONRenderer.vue')
...
const solutions = httpVueLoader('/vueui/solutions/Solutions.vue')
const solution = httpVueLoader('/vueui/solutions/Solution.vue')
const solutionChatflow = httpVueLoader('/vueui/solutions/SolutionChatflow.vue')
