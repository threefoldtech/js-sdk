...
class DocumentserverDeploy(MarketPlaceAppsChatflow):
    FLIST_URL = "https://hub.grid.tf/tobias.3bot/jimbersoftware-documentserver-grid-0.1.flist"
    SOLUTION_TYPE = "documentserver"
    title = "Documentserver"
    steps = [
        "get_solution_name",
        "documentserver_info",
    ...
    @chatflow_step(title="Documentserver Information")
    def documentserver_info(self):
