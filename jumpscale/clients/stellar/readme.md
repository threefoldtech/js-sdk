...
```python
JS-NG> w.manage_sell_order(selling_asset=xlm, buying_asset=tft, amount=decimal.Decimal(5), price=decimal.Decimal(20))
...
JS-NG> j.clients.stellar.tfta_acceptance.manage_sell_order(amount="0", offer_id=18858735, selling_asse
