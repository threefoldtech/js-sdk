...
#     def find(self, message: str = "", unread: bool = False, start_time: int = None, end_time: int = None) -> list:

#         """Find notifications

#         Keyword Arguments:
#             message {str} -- filter by notification message (default: {""})
#             unread {bool} -- filter unread messages (default: {False})
...
#             if unread and not notification.unread:
#                 continue
...
#         """
#         notification = self.get(notification_id=notification.id)
