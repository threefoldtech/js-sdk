...
nodes = list(j.sals.zos.get_zos_for().nodes_finder.nodes_by_capacity(cru=1, sru=10, mru=2, hru=5, currency="FreeTFT"))
...
```python
j.sals.zos.get_zos_for().billing.payout_farmers(wallet,reservation_response= registered_reservation)
