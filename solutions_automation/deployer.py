...
def deploy_ubuntu(
    ...
    ipv6="NO",
    node_automatic="No",
    node="8BFWcddW79cawvjnuUMw8M5s9FqS3pHhMHvzn3pgCUiB",
    ipv4="choose_random",
...
def deploy_monitoring(
    ...
    volume_size=10,
    network="choose_random",
    redis_node_select="NO",
    redis_pool="choose_random",
    redis_ip="choose_random",
    redis_node="8BFWcddW79cawvjnuUMw8M5s9FqS3pHhMHvzn3pgCUiB",
    prometheus_node_select="NO",
    prometheus_pool="choose_random",
    prometheus_ip="choose_random",
    prometheus_node="8BFWcddW79cawvjnuUMw8M5s9FqS3pHhMHvzn3pgCUiB",
    grafana_node_select="NO",
    grafana_pool="choose_random",
    grafana_ip="choose_random",
    grafana_node="8BFWcddW79cawvjnuUMw8M5s9FqS3pHhMHvzn3pgCUiB",
    debug=True,
):
