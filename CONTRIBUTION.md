...
Check out the [documentation](https://github.com/threefoldtech/js-sdk/tree/development/docs/wiki) learn about the code
base and setting up your development environment.
...
[GitHub issues](https://github.com/threefoldtech/js-sdk/issues/new) can be used to report bugs or submit feature requests.
...
- Any logs that contains some error message or useful information related to the bug
